<div class="" style="background:#0c0c0c; color:#fff"><center>Book Details</center></div>
...
%>
<div class="" style="background:#080808; color:#fff"><center>Student Details</center></div>
<dl class="dl-horizontal">
    <dt>Student ID</dt>
